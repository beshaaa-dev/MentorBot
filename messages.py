...
FINDING_USER = "Загружаем информацию..."
WELCOME = """
Привет! Это бот проекта «Поколение».
...
Нужно отправить видеокружок в Telegram
длительностью до 1 минуты.

В видео ответь на вопрос:
«Короткий случай из жизни,
который лучше всего тебя характеризует».

Важно:
— только видеокружок в Telegram 
— монтаж не нужен
— видно лицо, хороший звук
— отправить видеокружок нужно В ЭТОТ БОТ

⏳ Дедлайн: 24 часа
(отсчёт уже идёт)

После отправки заявка перейдёт
на этап рассмотрения 🧡
"""
