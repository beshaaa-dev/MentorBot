...
VIEW_ALL_BUTTON = "Просмотреть всех"
...
VOICE_MESSAGES_FORBIDDEN = "Не удалось отправить голосовое сообщение. Разрешите их, пожалуйста, в настройках."
...
DOWNLOAD_MENTOR_PDFS_BUTTON = "Анкеты наставника"
ENTER_MENTOR_NICKNAME_MESSAGE = "Введите Telegram-никнейм наставника (с @ или без):"
GENERATING_PDFS_MESSAGE = "⏳ Генерирую анкеты..."
MENTOR_NOT_FOUND_MESSAGE = "Наставник с никнеймом '@{nickname}' не найден в базе данных."
NO_TASKS_FOR_MENTOR_MESSAGE = "У наставника нет участников."
PDFS_DONE_MESSAGE = "✅ Готово. Отправлено: {generated}, пропущено: {skipped}."
